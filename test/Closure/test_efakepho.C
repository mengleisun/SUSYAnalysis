...
void test_efakepho(int ichannel){
...
//	if(channelType==2)raretree->Add("/uscms_data/d3/mengleis/FullStatusOct/resTree_mgsignal_WZ.root");
  ...
  TLine *flatratio = new TLine(35,1,200,1);
	...
	ratio->Draw("same");
	flatratio->Draw("same");
	c_pt->SaveAs("closure_elefakepho_PhotonEt_eg.png");
...
// ******** MET ************************//
  ...
  TLine *flatratio_met = new TLine(0,1,400,1);
	...
	line_met_ratio->Draw("same");
 	gPad->RedrawAxis();
	c_met->SaveAs("closure_elefakepho_MET_eg.png");
...
// ******** Mt ************************//
  ...
  TLine *flatratio_mt = new TLine(0,1,400,1);
	...
	c_mt->SaveAs("closure_elefakepho_MT_eg.png");
...
// ******** HT ************************//
  ...
  TLine *flatratio_HT = new TLine(0,1,400,1);
	...
	c_HT->SaveAs("closure_elefakepho_HT_eg.png");
