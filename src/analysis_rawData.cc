...
bool rawData::passHLT(){
  ...
  switch(runtype_){
    ...
    //case SingleElectron2017:if(((HLTEleMuX >> 59) &1) !=0)passDataHLT = true; break; // HLT_Ele20_eta2p1_WPLoose_Gsf_v not full period
    case SingleElectron2017:passDataHLT = true; break;
    case SingleElectron2018:if(((HLTEleMuX >> 59) &1) !=0)passDataHLT = true; break; // HLT_Ele20_eta2p1_WPLoose_Gsf_v full period
    ...
    case MCMuonEG2016: if(((HLTEleMuX >> 8) &1) !=0 || ((HLTEleMuX >> 41) &1) !=0)passDataHLT = true; break;
