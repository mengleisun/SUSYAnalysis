...
void FitKer(int inputfittype, float lowerptcut, float upperptcut, float loweretacut, float upperetacut){//main  
  ...
  gSystem->Load("/uscms/home/mengleis/work/SUSY2016/SUSYAnalysis/lib/libRooFitClasses.so");
	...
	float fitrangehigh = 110;
	float fitrangelow  = 70;
...
//************** Process Z->ee Tree ********************************************************//   
  ...
  etree->SetBranchAddress("probeMatchLeading",      &probeMatchLeading);
	etree->SetBranchAddress("probeMatchTrailing", 		&probeMatchTrailing);
