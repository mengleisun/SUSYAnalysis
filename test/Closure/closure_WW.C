...
void closure_WW(){//main 

  gSystem->Load("/uscms/home/mengleis/work/SUSY2016/SUSYAnalysis/lib/libAnaClasses.so");

  char outputname[100] = "/uscms_data/d3/mengleis/closureTree_elefake_WW.root";
  ofstream logfile;
  logfile.open("/uscms_data/d3/mengleis/closureTree_elefake_WW.log"); 
