...
process.source = cms.Source("PoolSource",
        ...
        '/store/user/msun/PhotonJet/PhotonJet/151118_204728/0000/PhotonJet_1.root'
        #'file:slhafragment_cff_GEN_SIM_RECOBEFMIX_DIGI_L1_L1Reco_RECO_HLT.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_PhotonJet.root'))
