...
void plot_eventct(){//main  
  ...
  gSystem->Load("/uscms/home/mengleis/work/SUSY2016/SUSYAnalysis/lib/libAnaClasses.so");
	...
	TH1D *h_elefakepho_norm           = new TH1D("h_elefakepho_norm",            "h_elefakepho_norm",           18,0,18); 
	TH1D *h_elefakepho_syserr_jes     = new TH1D("h_elefakepho_syserr_jes",      "h_elefakepho_syserr_jes",     18,0,18); 
	TH1D *h_elefakepho_syserr_jer     = new TH1D("h_elefakepho_syserr_jer",      "h_elefakepho_syserr_jer",     18,0,18);   
	TH1D *h_elefakepho_syserr_esf     = new TH1D("h_elefakepho_syserr_esf",      "h_elefakepho_syserr_esf",     18,0,18); 
	TH1D *h_elefakepho_syserr_scale   = new TH1D("h_elefakepho_syserr_scale",    "h_elefakepho_syserr_scale",   18,0,18); 
	TH1D *h_elefakepho_syserr_eleshape= new TH1D("h_elefakepho_syserr_eleshape", "h_elefakepho_syserr_eleshape",18,0,18); 
	TH1D *h_elefakepho_syserr_jetshape= new TH1D("h_elefakepho_syserr_jetshape", "h_elefakepho_syserr_jetshape",18,0,18); 
	TH1D *h_elefakepho_syserr_xs      = new TH1D("h_elefakepho_syserr_xs",       "h_elefakepho_syserr_xs",      18,0,18);
	TH1D *h_elefakepho_syserr_lumi    = new TH1D("h_elefakepho_syserr_lumi",     "h_elefakepho_syserr_lumi",    18,0,18); 
	                                                                                                          
	TH1D *h_jetfakepho_norm           = new TH1D("h_jetfakepho_norm",            "h_jetfakepho_norm",           18,0,18); 
	TH1D *h_jetfakepho_syserr_jes     = new TH1D("h_jetfakepho_syserr_jes",      "h_jetfakepho_syserr_jes",     18,0,18); 
	TH1D *h_jetfakepho_syserr_jer     = new TH1D("h_jetfakepho_syserr_jer",      "h_jetfakepho_syserr_jer",     18,0,18); 
	TH1D *h_jetfakepho_syserr_esf     = new TH1D("h_jetfakepho_syserr_esf",      "h_jetfakepho_syserr_esf",     18,0,18); 
	TH1D *h_jetfakepho_syserr_scale   = new TH1D("h_jetfakepho_syserr_scale",    "h_jetfakepho_syserr_scale",   18,0,18); 
	TH1D *h_jetfakepho_syserr_eleshape= new TH1D("h_jetfakepho_syserr_eleshape", "h_jetfakepho_syserr_eleshape",18,0,18); 
	TH1D *h_jetfakepho_syserr_jetshape= new TH1D("h_jetfakepho_syserr_jetshape", "h_jetfakepho_syserr_jetshape",18,0,18); 
	TH1D *h_jetfakepho_syserr_xs      = new TH1D("h_jetfakepho_syserr_xs",       "h_jetfakepho_syserr_xs",      18,0,18);
	TH1D *h_jetfakepho_syserr_lumi    = new TH1D("h_jetfakepho_syserr_lumi",     "h_jetfakepho_syserr_lumi",    18,0,18); 
	                                                                             
	TH1D *h_qcdfakelep_norm           = new TH1D("h_qcdfakelep_norm",            "h_qcdfakelep_norm",           18,0,18); 
	TH1D *h_qcdfakelep_syserr_jes     = new TH1D("h_qcdfakelep_syserr_jes",      "h_qcdfakelep_syserr_jes",     18,0,18); 
	TH1D *h_qcdfakelep_syserr_jer     = new TH1D("h_qcdfakelep_syserr_jer",      "h_qcdfakelep_syserr_jer",     18,0,18); 
	TH1D *h_qcdfakelep_syserr_esf     = new TH1D("h_qcdfakelep_syserr_esf",      "h_qcdfakelep_syserr_esf",     18,0,18); 
	TH1D *h_qcdfakelep_syserr_scale   = new TH1D("h_qcdfakelep_syserr_scale",    "h_qcdfakelep_syserr_scale",   18,0,18); 
	TH1D *h_qcdfakelep_syserr_eleshape= new TH1D("h_qcdfakelep_syserr_eleshape", "h_qcdfakelep_syserr_eleshape",18,0,18); 
	TH1D *h_qcdfakelep_syserr_jetshape= new TH1D("h_qcdfakelep_syserr_jetshape", "h_qcdfakelep_syserr_jetshape",18,0,18); 
	TH1D *h_qcdfakelep_syserr_xs      = new TH1D("h_qcdfakelep_syserr_xs",       "h_qcdfakelep_syserr_xs",      18,0,18);
	TH1D *h_qcdfakelep_syserr_lumi    = new TH1D("h_qcdfakelep_syserr_lumi",     "h_qcdfakelep_syserr_lumi",    18,0,18); 
	
	TH1D *h_VGamma_norm           = new TH1D("h_VGamma_norm",             "h_VGamma_norm",           18,0,18);   
	TH1D *h_VGamma_syserr_jes     = new TH1D("h_VGamma_syserr_jes",       "h_VGamma_syserr_jes",     18,0,18);   
	TH1D *h_VGamma_syserr_jer     = new TH1D("h_VGamma_syserr_jer",       "h_VGamma_syserr_jer",     18,0,18);   
	TH1D *h_VGamma_syserr_esf     = new TH1D("h_VGamma_syserr_esf",       "h_VGamma_syserr_esf",     18,0,18);   
	TH1D *h_VGamma_syserr_scale   = new TH1D("h_VGamma_syserr_scale",     "h_VGamma_syserr_scale",   18,0,18);   
	TH1D *h_VGamma_syserr_eleshape= new TH1D("h_VGamma_syserr_eleshape",  "h_VGamma_syserr_eleshape",18,0,18);   
	TH1D *h_VGamma_syserr_jetshape= new TH1D("h_VGamma_syserr_jetshape",  "h_VGamma_syserr_jetshape",18,0,18);   
	TH1D *h_VGamma_syserr_xs      = new TH1D("h_VGamma_syserr_xs",        "h_VGamma_syserr_xs",      18,0,18);   
	TH1D *h_VGamma_syserr_lumi    = new TH1D("h_VGamma_syserr_lumi",      "h_VGamma_syserr_lumi",    18,0,18);   
	
	TH1D *h_rare_norm           = new TH1D("h_rare_norm",              "h_rare_norm",           18,0,18);   
	TH1D *h_rare_syserr_jes     = new TH1D("h_rare_syserr_jes",        "h_rare_syserr_jes",     18,0,18);   
	TH1D *h_rare_syserr_jer     = new TH1D("h_rare_syserr_jer",        "h_rare_syserr_jer",     18,0,18);   
	TH1D *h_rare_syserr_esf     = new TH1D("h_rare_syserr_esf",        "h_rare_syserr_esf",     18,0,18);   
	TH1D *h_rare_syserr_scale   = new TH1D("h_rare_syserr_scale",      "h_rare_syserr_scale",   18,0,18);   
	TH1D *h_rare_syserr_eleshape= new TH1D("h_rare_syserr_eleshape",   "h_rare_syserr_eleshape",18,0,18);   
	TH1D *h_rare_syserr_jetshape= new TH1D("h_rare_syserr_jetshape",   "h_rare_syserr_jetshape",18,0,18);   
	TH1D *h_rare_syserr_xs      = new TH1D("h_rare_syserr_xs",         "h_rare_syserr_xs",      18,0,18);   
	TH1D *h_rare_syserr_lumi    = new TH1D("h_rare_syserr_lumi",       "h_rare_syserr_lumi",    18,0,18);   
	...
	for(unsigned ibin(1); ibin <= 9; ibin++){
	...
	for(unsigned ibin(1); ibin <= 9; ibin++){
		...
		h_elefakepho_norm->SetBinContent(ibin+9, eg_elefakepho_norm->GetBinContent(ibin));
		h_elefakepho_syserr_jes->SetBinContent(ibin+9,      eg_elefakepho_syserr_jes->GetBinContent(ibin));      
		h_elefakepho_syserr_jer->SetBinContent(ibin+9,      eg_elefakepho_syserr_jer->GetBinContent(ibin)); 
		h_elefakepho_syserr_esf->SetBinContent(ibin+9,      eg_elefakepho_syserr_esf->GetBinContent(ibin));      
		h_elefakepho_syserr_scale->SetBinContent(ibin+9,    eg_elefakepho_syserr_scale->GetBinContent(ibin));    
		h_elefakepho_syserr_eleshape->SetBinContent(ibin+9, eg_elefakepho_syserr_eleshape->GetBinContent(ibin));
		h_elefakepho_syserr_jetshape->SetBinContent(ibin+9, eg_elefakepho_syserr_jetshape->GetBinContent(ibin));
		h_elefakepho_syserr_xs->SetBinContent(ibin+9,       eg_elefakepho_syserr_xs->GetBinContent(ibin));       
		h_elefakepho_syserr_lumi->SetBinContent(ibin+9,     eg_elefakepho_syserr_lumi->GetBinContent(ibin));     
																																																																																																							
		h_jetfakepho_norm->SetBinContent(ibin+9,            eg_jetfakepho_norm->GetBinContent(ibin));            
		h_jetfakepho_syserr_jes->SetBinContent(ibin+9,      eg_jetfakepho_syserr_jes->GetBinContent(ibin));      
		h_jetfakepho_syserr_jer->SetBinContent(ibin+9,      eg_jetfakepho_syserr_jer->GetBinContent(ibin));      
		h_jetfakepho_syserr_esf->SetBinContent(ibin+9,      eg_jetfakepho_syserr_esf->GetBinContent(ibin));      
		h_jetfakepho_syserr_scale->SetBinContent(ibin+9,    eg_jetfakepho_syserr_scale->GetBinContent(ibin));    
		h_jetfakepho_syserr_eleshape->SetBinContent(ibin+9, eg_jetfakepho_syserr_eleshape->GetBinContent(ibin));
		h_jetfakepho_syserr_jetshape->SetBinContent(ibin+9, eg_jetfakepho_syserr_jetshape->GetBinContent(ibin));
		h_jetfakepho_syserr_xs->SetBinContent(ibin+9,       eg_jetfakepho_syserr_xs->GetBinContent(ibin));       
		h_jetfakepho_syserr_lumi->SetBinContent(ibin+9,     eg_jetfakepho_syserr_lumi->GetBinContent(ibin));     
																														
		h_qcdfakelep_norm->SetBinContent(ibin+9,            eg_qcdfakelep_norm->GetBinContent(ibin));            
		h_qcdfakelep_syserr_jes->SetBinContent(ibin+9,      eg_qcdfakelep_syserr_jes->GetBinContent(ibin));      
		h_qcdfakelep_syserr_jer->SetBinContent(ibin+9,      eg_qcdfakelep_syserr_jer->GetBinContent(ibin));      
		h_qcdfakelep_syserr_esf->SetBinContent(ibin+9,      eg_qcdfakelep_syserr_esf->GetBinContent(ibin));      
		h_qcdfakelep_syserr_scale->SetBinContent(ibin+9,    eg_qcdfakelep_syserr_scale->GetBinContent(ibin));    
		h_qcdfakelep_syserr_eleshape->SetBinContent(ibin+9, eg_qcdfakelep_syserr_eleshape->GetBinContent(ibin));
		h_qcdfakelep_syserr_jetshape->SetBinContent(ibin+9, eg_qcdfakelep_syserr_jetshape->GetBinContent(ibin));
		h_qcdfakelep_syserr_xs->SetBinContent(ibin+9,       eg_qcdfakelep_syserr_xs->GetBinContent(ibin));       
		h_qcdfakelep_syserr_lumi->SetBinContent(ibin+9,     eg_qcdfakelep_syserr_lumi->GetBinContent(ibin));     
																
		h_VGamma_norm->SetBinContent(ibin+9,                eg_VGamma_norm->GetBinContent(ibin));            
		h_VGamma_syserr_jes->SetBinContent(ibin+9,          eg_VGamma_syserr_jes->GetBinContent(ibin));      
		h_VGamma_syserr_jer->SetBinContent(ibin+9,          eg_VGamma_syserr_jer->GetBinContent(ibin));      
		h_VGamma_syserr_esf->SetBinContent(ibin+9,          eg_VGamma_syserr_esf->GetBinContent(ibin));      
		h_VGamma_syserr_scale->SetBinContent(ibin+9,        eg_VGamma_syserr_scale->GetBinContent(ibin));    
		h_VGamma_syserr_eleshape->SetBinContent(ibin+9,     eg_VGamma_syserr_eleshape->GetBinContent(ibin));
		h_VGamma_syserr_jetshape->SetBinContent(ibin+9,     eg_VGamma_syserr_jetshape->GetBinContent(ibin));
		h_VGamma_syserr_xs->SetBinContent(ibin+9,           eg_VGamma_syserr_xs->GetBinContent(ibin));       
		h_VGamma_syserr_lumi->SetBinContent(ibin+9,         eg_VGamma_syserr_lumi->GetBinContent(ibin));     
																
		h_rare_norm->SetBinContent(ibin+9,                  eg_rare_norm->GetBinContent(ibin));            
		h_rare_syserr_jes->SetBinContent(ibin+9,            eg_rare_syserr_jes->GetBinContent(ibin));      
		h_rare_syserr_jer->SetBinContent(ibin+9,            eg_rare_syserr_jer->GetBinContent(ibin));      
		h_rare_syserr_esf->SetBinContent(ibin+9,            eg_rare_syserr_esf->GetBinContent(ibin));      
		h_rare_syserr_scale->SetBinContent(ibin+9,          eg_rare_syserr_scale->GetBinContent(ibin));   
		h_rare_syserr_eleshape->SetBinContent(ibin+9,       eg_rare_syserr_eleshape->GetBinContent(ibin));   
		h_rare_syserr_jetshape->SetBinContent(ibin+9,       eg_rare_syserr_jetshape->GetBinContent(ibin)); 
		h_rare_syserr_xs->SetBinContent(ibin+9,             eg_rare_syserr_xs->GetBinContent(ibin));       
		h_rare_syserr_lumi->SetBinContent(ibin+9,           eg_rare_syserr_lumi->GetBinContent(ibin));     
		...
		h_elefakepho_norm->SetBinError(ibin+9,          eg_elefakepho_norm->GetBinError(ibin));
		h_jetfakepho_norm->SetBinError(ibin+9,          eg_jetfakepho_norm->GetBinError(ibin));            
		h_qcdfakelep_norm->SetBinError(ibin+9,          eg_qcdfakelep_norm->GetBinError(ibin));            
		h_VGamma_norm->SetBinError(ibin+9,              eg_VGamma_norm->GetBinError(ibin));            
		h_rare_norm->SetBinError(ibin+9,                eg_rare_norm->GetBinError(ibin));            
	}
