...
//	p_rarePU->Reset();
  ...
  TLine *flatratio = new TLine(35,1,800,1);
	...
	ratio->Draw("same");
	flatratio->Draw("same");
	c_pt->SaveAs("ENDCAP_mg_2016ReMiniAOD_pt.pdf");
...
//	leg_susy->Draw("same");
  ...
  TLine *flatratio_met = new TLine(0,1,1000,1);
	...
	c_met->SaveAs("ENDCAP_mg_2016ReMiniAOD_met.pdf");
...
//		prederror += p_rareLepPt->GetBinError(ibin);
  ...
  TLine *flatratio_leppt = new TLine(25,1,800,1);
	...
	c_leppt->SaveAs("ENDCAP_mg_2016ReMiniAOD_leppt.pdf");
// ******** Mt ************************//
	gStyle->SetOptStat(0);
...
//		prederror += p_rareMt->GetBinError(ibin);
  ...
  TLine *flatratio_mt = new TLine(0,1,800,1);
	...
	c_mt->SaveAs("ENDCAP_mg_2016ReMiniAOD_mt.pdf");
...
// ******** HT ************************//
  ...
  TLine *flatratio_HT = new TLine(0,1,999,1);
	...
	c_HT->SaveAs("ENDCAP_mg_2016ReMiniAOD_HT.pdf");
