...
for ij in files:
    ...
    count += 1
#   fileParts.append("Output    = logs/signaljob17{}_$(Cluster)_$(Process).stdout\n".format(count))
#    fileParts.append("error     = logs/signaljob17{}_$(Cluster)_$(Process).stderr\n".format(count))
    fileParts.append("Log       = logs/signaljob17{}_$(Cluster)_$(Process).log\n".format(count))
