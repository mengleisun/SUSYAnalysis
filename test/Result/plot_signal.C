...
//	TFile *file_sig = TFile::Open("signalTree_egamma_signal_ReMiniAOD.root");
//	TFile *file_ele = TFile::Open("signalTree_egamma_eleBkg_ReMiniAOD.root");
//	TFile *file_jet = TFile::Open("signalTree_egamma_jetbkg_ReMiniAOD.root");
//	TFile *file_qcd = TFile::Open("signalTree_egamma_qcd_ReMiniAOD.root");
//	TFile *file_VG  = TFile::Open("signalTree_egamma_VGBkg_ReMiniAOD.root");
//	TFile *file_rare= TFile::Open("signalTree_egamma_rareBkg_ReMiniAOD.root");

//	TFile *file_sig = TFile::Open("signalTree_egamma_signal_ReMiniAOD.root");
//	TFile *file_ele = TFile::Open("signalTree_egamma_eleBkg_ReMiniAOD.root");
//	TFile *file_jet = TFile::Open("signalTree_egamma_jetbkg_ReMiniAOD.root");
//	TFile *file_qcd = TFile::Open("signalTree_egamma_qcd_ReMiniAOD.root");
//	TFile *file_VG  = TFile::Open("signalTree_egamma_VGBkg_wgt.root");
//	TFile *file_rare= TFile::Open("signalTree_egamma_rareBkg_ReMiniAOD.root");

	TFile *file_sig = TFile::Open("signalTree_egamma_signal.root");
	TFile *file_ele = TFile::Open("signalTree_egamma_eleBkg.root");
	TFile *file_jet = TFile::Open("signalTree_egamma_jetbkg.root");
	TFile *file_qcd = TFile::Open("signalTree_egamma_qcd.root");
	TFile *file_VG  = TFile::Open("signalTree_egamma_VGBkg.root");
	TFile *file_rare= TFile::Open("signalTree_egamma_rareBkg.root");
...
//	p_rareMET->Rebin(10);
	...
	p_allPhoEt->GetXaxis()->SetRangeUser(35,1000);
  ...
  error_PhoEt->SetFillStyle(3001);
	...
	pt_pad2->Draw();
	pt_pad2->cd();
  TLine *flatratio = new TLine(35,1,1000,1);
	...
	ratio->Draw("same");
	flatratio->Draw("same");
	c_pt->SaveAs("SIGNAL_egamma_2016ReMiniAOD_pt.pdf");
...
// ******** MET ************************//
  ...
  TLine *flatratio_met = new TLine(0,1,1000,1);
	...
	c_met->SaveAs("SIGNAL_egamma_2016ReMiniAOD_met.pdf");
...
//		prederror += p_rareLepPt->GetBinError(ibin);
  ...
  TLine *flatratio_leppt = new TLine(25,1,400,1);
	...
	c_leppt->SaveAs("SIGNAL_egamma_2016ReMiniAOD_leppt.pdf");
// ******** Mt ************************//
	gStyle->SetOptStat(0);
...
//		prederror += p_rareMt->GetBinError(ibin);
  ...
  TLine *flatratio_mt = new TLine(0,1,1000,1);
	...
	c_mt->SaveAs("SIGNAL_egamma_2016ReMiniAOD_mt.pdf");
